...
#Calculting the population of every state and respresenting it by a circle at the center of the state and 
#the larger the circle means the larger the population of that particular state
